...
export default function PersonaSelect() {
  ...
  const createPersonaMutation = useMutation({
    ...
    onSuccess: (created) => {
      ...
      localStorage.setItem("selectedCompanyPersonaId", created.id);
      resetDraft();
  ...
  const updatePersonaMutation = useMutation({
    ...
    onSuccess: (updated) => {
      ...
      localStorage.setItem("selectedCompanyPersonaId", updated.id);
      setIsEditingPersona(false);
      setPersonaError("");
  ...
  const handleStartEdit = useCallback((persona) => {
    ...
    localStorage.setItem("selectedCompanyPersonaId", persona.id);
    setPersonaDraft({
      name: persona.name || "",
